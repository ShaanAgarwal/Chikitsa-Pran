...
const { registerHospital,addMedicalEquipment, createOperationTheatre, updateMedicalEquipment, updateOperationTheatre, createDoctor, updateDoctor, getHospitals } = require('../controller/hospitalController');
